export default {
  ...
  phrases: {
    ...
    youHaveReceived: 'You received a payment of',
    ...
    aboutDeleting: 'About deleting notification.',
    ...
    fapshiPayment: 'Fapshi Payment',
    transferId: 'Transfer ID',
    fapshiTopup: 'FAPSHI Topup',
    fapshiTransfer: 'FAPSHI Transfers',
    fapshiPayout: 'FAPSHI Payout',
    fapshiPay: 'FAPSHI Pay',
    depositNumber: 'Deposit Number',
    viewTopups: 'View your Topups',
    viewPayouts: 'View your Payouts',
    viewTransfers: 'View your transfers',
